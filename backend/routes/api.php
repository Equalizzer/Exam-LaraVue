...
Route::group([
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::prefix('friend-request')->group(function (Router $router) {
            ...
            $router->post('deny', [FriendRequestController::class, 'denyFriendRequest']);
        });
        ...
        Route::group([
            ...
            $router->patch('user/block', [AdminController::class, 'blockUser']);
            $router->patch('user/unblock', [AdminController::class, 'unblockUser']);
            $router->delete('user/{userId}', [AdminController::class, 'deleteUser']);
        });
    });
});
